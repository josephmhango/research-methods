...
We now have: 
- A conceptual grounding in **bias and variance**
- A working picture of **design-based vs model-based** inference
- An overview of common designs: **SRS, stratified, cluster**
- Theoretical tools for **sample size**, **effect size**, and **Type I / II errors**.
