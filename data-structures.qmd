...
R works with different kinds of **data objects**, and each object has an associated **type**. These types determine what operations are possible and how the data is treated during analysis. All the data you create lives in the **Global Environment**, and itâ€™s important to know what kind of data youâ€™re working with.

R is pretty good at guessing what type your data should be â€” but this can sometimes backfire. Think of R as a *passive-aggressive butler*: it tries to help, but doesnâ€™t always tell you when itâ€™s done something â€œhelpful.â€ So, you should learn to check and control data types explicitly.
...
There are a few special types of values that youâ€™ll come across often:
...
- Avoid spaces â€” use underscores or camelCase instead.
...
Letâ€™s say you want to analyse categorical data. Sometimes this is called a *factor*.
:::

::: {.column width="50%"}

![](pics/mean_mark_boxplot_ggplot2.png)
:::
:::
